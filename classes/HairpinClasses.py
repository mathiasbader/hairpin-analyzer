...
# --  Zeile 592 von Julia geadded, wegen Mutationsanalyse - incorrecte snps werden nicht mehr aussortiert   --
# ---------------------------------------------------
# 
...
class HairpinData:
    ...
    filepath = ""
    sub_path = ""
    filepaths_additional = []
    filename_datafile = ""
    filename_datafile_snp = ""
    filename_summaryfile = ""
    amplicon_type = ""
    metadata = []
    data     = []
    row_count        = 0
    ...
    additional_data_available["linker"]  = False
    additional_data_available["non_cpg"] = False
    additional_data_available["snp"]     = False
    ...
    columns_to_capture_add["non_cpg"] = [
                                         1,   # ID
                                         4    # CG_Methylation_Pattern
                                        ]
    ...
    def __init__(self, sub_path):
        ...
        self.additional_data_available = {}
        self.additional_data_available["linker"]  = False
        self.additional_data_available["non_cpg"] = False
        self.additional_data_available["snp"]     = False
        ...
        self.filename_summaryfile  = Configuration.filename_results_summary

        # read the specified file
        self.sub_path = sub_path
        self.filepath = Configuration.data_path_cpg.strip()
        self.filepaths_additional = Configuration.data_paths_additional
        main_folder = Configuration.data_path_main_folder
        self.filepath = main_folder + self.filepath
        for i in range(len(self.filepaths_additional)):
            self.filepaths_additional[i][1] = main_folder + self.filepaths_additional[i][1]
    ...
    def bind_additional_data_to_results(self):
        ...
        for filepath_additional in self.filepaths_additional:
        ...
        if self.additional_data_available["snp"]:
            ...
            for i in range(len(self.results)):
                ...
                if (percentage == "_" or float(percentage) == 1.0):
                    ...
                    new_results.append(self.results[i])    #zeile loeschen, wenn nicht passende snps aussortiert werden sollen                
    ...
    def calculate_statistics(self):
        ...
        for full_line in self.results:
            ...
            if (not all_positions_mutated):
                ...
                struc = HairpinFunctionality.define_structure(result)
                if (struc == "only_one"):
                    self.info_stats_only_one += 1
                elif (struc == "mosaic"):
                    self.info_stats_mosaic += 1
                elif (struc == "continuous"):
    ...
    def write_results_to_file(self, output_filename):
        """Writes results into specified textfile"""
    ...
    def create_image(self, output_filename):
        ...
        for full_line in self.results:
            line = full_line[0]
            for i in range(self.mapped_col_count):
                # drawing the individual datapoints
                x1 = 0
        ...
        # drawing lines seperating the percentages
    ...
    def get_linker_mean_methylation_level(self):
        ...
        filename = self.filepaths_additional[0][1] + self.sub_path + self.filename_summaryfile
...
class HairpinFunctionality:
    ...
    def define_structure(data):
        """Analyse wether strand has 'only_one', 'mosaic' or 'continuous' pattern"""
